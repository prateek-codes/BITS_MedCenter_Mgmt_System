...
<%
    try{
        ...
        statement1=connection1.prepareStatement("select * from user_data where email=?");
    ...
    <div class="view-account">
        <section class="module">
            <div class="module-inner">
                <div class="side-bar">
                    <div class="user-info">
                        <img class="img-profile img-circle img-responsive center-block" src="getImage.jsp?email=<%=resultSet1.getString("email") %>" alt="">
                        <ul class="meta list list-unstyled">
                            <li class="name"><%=resultSet1.getString("Name") %>
                                <label class="label label-info"><%=resultSet1.getString("BITS_ID") %></label>
                            </li>
                            <li class="email"><a href="#"><%=resultSet1.getString("email") %></a></li>
                        </ul>
                    </div>
                    <nav class="side-menu">
                        <ul class="nav">
                            <li><a href="userprofile.jsp"><span class="fa fa-user"></span> Profile</a></li>
                            ...
                            <li class="active"><a href="DoctorProfile.jsp"><span class="fa fa-clock-o"></span> Book Appointments</a></li>
    ...
    <div class="column">
        <div class="card">
            ...
            <div class="container">
                ...
                <script>
                    function book() {
                        var url = "appointment.jsp?url=" + encodeURIComponent("https://calendar.google.com/calendar/selfsched?sstoken=UU5FaUtyZFExSHBNfGRlZmF1bHR8NDI1ZTUxYTE2MzBmZDg5ZTJmZWEyNTBkMTQ0MzY2NjM");
                        window.location.href = url;
                    }
                </script>
                <p><button class="button" id="book" onclick="book()">Book Appointment</button></p>
            </div>
        </div>
    </div>
    <%
