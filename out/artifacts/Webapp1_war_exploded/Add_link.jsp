        ...
        <section class="module">
            <div class="module-inner">
                ...
                <div class="content-panel">
                    <h2 class="title">Add Google Calender Link</h2>
                    <form class="form-horizontal" method="post" action="Add_link_update.jsp">
                        ...
                        <fieldset class="fieldset">
                            ...
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label">Link</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
