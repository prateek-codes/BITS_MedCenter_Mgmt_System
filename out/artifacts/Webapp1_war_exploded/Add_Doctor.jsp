        ...
        <section class="module">
            <div class="module-inner">
                ...
                <div class="content-panel">
                    ...
                    <div class="row">
                        <div class="column">
                            <form action="New_doctor_detail.jsp" class="w3-container w3-display-middle w3-round-xlarge w3-card-4 w3-light-grey w3-text-blue w3-margin" style="width:50%">
                                <h2 class="w3-center">Doctor Sign-Up</h2>

                                <div class="w3-row w3-section">
                                    <div class="w3-col" style="width:50px"><i class="w3-xlarge fa fa-user"></i></div>
                                    <div class="w3-rest">
                                        <input class="w3-input w3-border w3-round-large" name="Name" type="text" placeholder="Full Name">
                                    </div>
                                </div>
                                ...
                                <div class="w3-row w3-section">
                                    <div class="w3-col" style="width:50px"><i class="w3-xlarge fa fa-user"></i></div>
                                    <div class="w3-rest">
                                        <input class="w3-input w3-border w3-round-large" name="gender" type="text" placeholder="Gender">
                                    </div>
                                </div>
                                ...
                                <div class="w3-row w3-section">
                                    ...
                                    <div class="w3-rest">
                                        <input class="w3-input w3-border w3-round-large" name="Email" type="text" placeholder="Email">
                                    </div>
                                </div>
                                ...
                                <div class="w3-row w3-section">
                                    ...
                                    <div class="w3-rest">
                                        <input class="w3-input w3-border w3-round-large" name="Mobile_No" type="text" placeholder="Phone">
                                    </div>
                                </div>
                                ...
                                <div class="w3-row w3-section">
                                    ...
                                    <div class="w3-rest">
                                        <input class="w3-input w3-border w3-round-large" name="Specialization" type="text" placeholder="Specialization">
                                    </div>
                                </div>
                                <div class="w3-row w3-section">
                                    <div class="w3-col" style="width:50px"><i class="w3-xlarge fa fa-pencil"></i></div>
                                    <div class="w3-rest">
                                        <input class="w3-input w3-border w3-round-large" name="Experience" type="text" placeholder="Working Experience">
                                    </div>
                                </div>
                                <div class="w3-row w3-section">
                                    <div class="w3-col" style="width:50px"><i class="w3-xlarge fa fa-lock"></i></div>
                                    <div class="w3-rest">
                                        <input class="w3-input w3-border w3-round-large" name="Password" type="password" placeholder="Password">
                                    </div>
                                </div>

                                <button class="w3-button w3-block w3-section w3-blue w3-ripple w3-padding">Add</button>
